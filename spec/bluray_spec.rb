...
describe Bluray do
  before(:context) do
    # initialize item
    @blueray = Bluray.new('Finding Nemo', 12.99, 120, "Andrew Stanton", "Graham Walters")
  end
  ...
  describe "initialization" do
    ...
    it "should be assigned a price" do
      expect(@blueray.price).to eq (12.99)
    end
    ...
    it "should be assigned a director" do
      expect(@blueray.director).to eq("Andrew Stanton")
    end

    it "should be assigned a producer" do
      expect(@blueray.producer).to eq("Graham Walters")
    end
  end
